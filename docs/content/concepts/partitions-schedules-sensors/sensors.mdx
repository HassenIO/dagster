...
<PyObject object="make_email_on_run_failure_sensor" /> helps
...
For more examples of sensors, check out the following in our [Hacker News example](https://github.com/dagster-io/dagster/tree/master/examples/hacker_news_assets):

- [Sensor factory](https://github.com/dagster-io/dagster/blob/master/examples/hacker_news_assets/hacker_news_assets/sensors/hn_tables_updated_sensor.py)
